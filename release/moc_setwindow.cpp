...
QT_MOC_LITERAL(10, 11), // "FrameSignal"
QT_MOC_LITERAL(22, 0), // ""
QT_MOC_LITERAL(23, 15), // "PlaySpeedSignal"
QT_MOC_LITERAL(39, 21), // "on_toolButton_clicked"
QT_MOC_LITERAL(61, 23), // "on_toolButton_3_clicked"
QT_MOC_LITERAL(85, 23) // "on_toolButton_2_clicked"

    },
    "SetWindow\0FrameSignal\0\0PlaySpeedSignal\0"
...
void SetWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->FrameSignal((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->PlaySpeedSignal((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (SetWindow::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SetWindow::FrameSignal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SetWindow::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SetWindow::PlaySpeedSignal)) {
                *result = 1;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<SetWindow, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<int, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<int, std::false_type>
...
// SIGNAL 0
void SetWindow::FrameSignal(int _t1)
{
...
// SIGNAL 1
void SetWindow::PlaySpeedSignal(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
